...
export const gardenTasks: GardenTask[] = [
  ...
  // ═══════════════════════════════
  {
    ...
    description: "Agrega una capa de 5-7 cm de compost sobre tus camas de cultivo sin picar la tierra. 'La tierra no se pica'. Simplemente agrega compost fresco y deja que la microbiología del suelo haga su trabajo.",
    description_en: "Add a 5-7 cm layer of compost on top of your garden beds without tilling. 'Don't dig the soil'. Simply add fresh compost and let soil biology do the work.",
    season: "otoño",
    months: [3, 4, 5],
    category: "suelo",
    emoji: "🌍",
  ...
  },
  {
    ...
    description: "Cubre toda tierra expuesta con una capa de 3-5 cm de mulch (paja, hojas secas, chips de madera). 'La tierra descubierta es antinatural. No existe por sí sola y cuando existe, la llamamos desierto.'",
    description_en: "Cover all exposed soil with a 3-5 cm layer of mulch (straw, dry leaves, wood chips). 'Bare soil is unnatural. It doesn't exist on its own and when it does, we call it desert.'",
    season: "otoño",
    months: [3, 4, 5],
    category: "suelo",
    emoji: "🍂",
  ...
  },
  {
    ...
    description: "Cosecha semillas de tus mejores plantas (tomates, porotos, flores). Sécalas bien y guárdalas en sobres etiquetados. 'La semilla lo es todo. Desde ella comienza la vida en nuestros huertos.'",
    description_en: "Harvest seeds from your best plants (tomatoes, beans, flowers). Dry them well and store in labeled envelopes. 'The seed is everything. Life in our gardens begins from it.'",
    season: "otoño",
    months: [3],
  ...
  // OTOÑO – Abril
  {
    ...
    description: "Los ajos se plantan a 5 cm de profundidad con la punta hacia arriba. Temperatura ideal: 0° a 15°C. 'Siempre algo que huela abajo' en cada bancal.",
    description_en: "Plant garlic 5 cm deep with tips pointing up. Ideal temperature: 0° to 15°C. 'Always something that smells underground' in every bed.",
    season: "otoño",
    months: [4],
    category: "siembra",
    emoji: "🧄",
  ...
  },
  {
    ...
    description: "Agrega una capa extra de mulch alrededor de plantas sensibles. Las heladas no solo afectan por temperatura sino por duración.",
    description_en: "Add an extra layer of mulch around sensitive plants. Frost damage depends not only on temperature but also on duration.",
    season: "invierno",
    months: [6, 7, 8],
    category: "general",
    emoji: "❄️",
  ...
  // INVIERNO – Agosto
  {
    ...
    description: "Comienza los almácigos de tomates, pimientos y berenjenas 6-8 semanas antes de la última helada. Usa el método del platito: papel absorbente húmedo dentro de una bolsa plástica.",
    description_en: "Start tomato, pepper and eggplant seedlings 6-8 weeks before last frost. Use the saucer method: moist paper towel inside a plastic bag.",
    season: "invierno",
    months: [8],
    category: "siembra",
    emoji: "🌱",
  ...
  // ═══════════════════════════════
  {
    ...
    description: "Usa la 'prueba del dedo': mete un dedo 4 cm en la tierra. Si sale seco, riega. Si sale húmedo, espera. Como mínimo, ~2.4 litros por semana por planta.",
    description_en: "Use the 'finger test': insert a finger 4 cm into soil. If dry, water. If moist, wait. Minimum ~2.4 liters per week per plant.",
    season: "primavera",
    months: [9, 10, 11],
    category: "riego",
    emoji: "💧",
  ...
  // PRIMAVERA – Septiembre
  {
    ...
    description: "Cuando pase el riesgo de heladas, trasplanta tomates, pimientos y berenjenas. Hazlo al atardecer para reducir el estrés de la planta.",
    description_en: "When frost risk has passed, transplant tomatoes, peppers and eggplants. Do it at dusk to reduce plant stress.",
    season: "primavera",
    months: [9],
    category: "siembra",
    emoji: "🌿",
  ...
  },
  {
    ...
    description: "Planta albahaca, cilantro, perejil y eneldo entre tus hortalizas. Los bancales siempre deberían tener aromáticas que repelen pulgones y mosquita blanca.",
    description_en: "Plant basil, cilantro, parsley and dill among your vegetables. Garden beds should always have aromatics that repel aphids and whitefly.",
    season: "primavera",
    months: [9],
    category: "siembra",
    emoji: "🌿",
  ...
  },
  {
    ...
    description: "Siembra girasoles, cosmos, zinnias y caléndulas. Las flores son importantísimas dentro del huerto: atraen polinizadores y repelen plagas.",
    description_en: "Sow sunflowers, cosmos, zinnias and marigolds. Flowers are extremely important in the garden: they attract pollinators and repel pests.",
    season: "primavera",
    months: [9],
    category: "siembra",
    emoji: "🌻",
  ...
  // PRIMAVERA – Octubre
  {
    ...
    description: "Cuando la tierra está cálida (>18°C), siembra directamente zapallitos, porotos, maíz y pepinos.",
    description_en: "When soil is warm (>18°C), direct sow squash, beans, corn and cucumbers.",
    season: "primavera",
    months: [10],
    category: "siembra",
    emoji: "🎃",
  ...
  },
  {
    ...
    description: "Cuando las plantas están dando fruto, riega por más rato y con menos frecuencia. Esto incentiva raíces profundas y plantas más resistentes.",
    description_en: "When plants are fruiting, water longer and less frequently. This encourages deep roots and more resilient plants.",
    season: "verano",
    months: [12, 1, 2],
    category: "riego",
    emoji: "💧",
